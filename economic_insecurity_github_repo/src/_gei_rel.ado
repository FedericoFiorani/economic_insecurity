*-----------------------------------------------------------*
* Program: _gei_rel.ado                                     *
* Purpose: Generate Relative Economic Insecurity Variable   *
* Authors: De Sandi & Fiorani                               *
*-----------------------------------------------------------*

program define _gei_rel
    version 11.0
    ...
    *------------------------------------------------------------*
    * Calculate one-period relative insecurity
    *------------------------------------------------------------*
    tempvar lag_income insec_rel
    ...
    *------------------------------------------------------------*
    * Discount one-period relative insecurity
    *------------------------------------------------------------*
    forvalues k = 1/`p' {
        tempvar discounted_rel_`k'
    ...
    *------------------------------------------------------------*
    ...
    forvalues m = 1/`p' {
        replace `outvar' = `total_rel_`m'' if `t_index_`m'' == 1
    }
    ...
    *------------------------------------------------------------*
    ...
    merge 1:1 `id' `time' using "`_ei_r'", keep(match master) nogen noreport
